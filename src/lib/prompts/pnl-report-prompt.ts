...
export const PNL_REPORT_PROMPT = `You are an expert financial analyst AI specialising in Kenyan real estate accounting. Your primary task is to generate a professional, well-structured Profit and Loss (P&L) Statement for {{companyName}} covering the period from {{startDate}} to {{endDate}}.
