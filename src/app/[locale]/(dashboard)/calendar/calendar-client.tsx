...
import type { Property, RevenueTransaction, Expense, Tenancy, MaintenanceRequest } from '@/lib/types';
...
export default function CalendarClient({
    ...
    const { user } = useUser();
    // const { properties, revenue, expenses, maintenanceRequests, tenancies, loading: dataContextLoading, error: dataContextError } = useDataContext(); // Removed

    const properties = initialProperties;
    const revenue = initialRevenue;
    const expenses = initialExpenses;
    const tenancies = initialTenancies;
    const maintenanceRequests = initialMaintenanceRequests;
        ...
        tenancies.forEach(tenancy => {
            if (tenancy.startDate) {
                events.push({
                    ...
                    date: new Date(tenancy.startDate),
                    type: 'tenancy',
        ...
        maintenanceRequests.forEach(request => {
            if (request.scheduledDate) {
                events.push({
                    ...
                    date: new Date(request.scheduledDate),
                    type: 'maintenance',
