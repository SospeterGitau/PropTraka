...
import type { Property, Contractor } from '@/lib/types';
...
export default function AddExpenseClient({ initialProperties = [], initialContractors = [] }: AddExpenseClientProps) {
  const router = useRouter();
  // const { properties, contractors } = useDataContext(); // Removed
