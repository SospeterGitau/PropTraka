  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto prose prose-sm sm:prose-base">
        ...
        <h3 className="pt-4">1. Introduction</h3>
        <p>
        ...
        <h3 className="pt-4">2. Data We Process</h3>
        <p>
        ...
        <h3 className="pt-4">3. Purpose of Data Processing</h3>
        <p>
        ...
        <h3 className="pt-4">4. Lawful Basis for Processing</h3>
        <p>
        ...
        <h3 className="pt-4">5. Data Storage and Security</h3>
        <p>
        ...
        <h3 className="pt-4">6. Data Retention</h3>
        <p>
        ...
        <h3 className="pt-4">7. Data Subject Rights</h3>
        <p>
        ...
        <h3 className="pt-4">8. Changes to this Privacy Policy</h3>
        <p>
          We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.
        </p>

        <h3 className="pt-4">9. Disclaimer</h3>
        <p>
