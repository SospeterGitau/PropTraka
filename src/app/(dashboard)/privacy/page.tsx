  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto prose prose-sm sm:prose-base">
        ...
        <h2 className="pt-4">2. Data We Process</h2>
        <p>
        ...
        <h2 className="pt-4">3. Purpose of Data Processing</h2>
        <p>
        ...
        <h2 className="pt-4">4. Lawful Basis for Processing</h2>
        <p>
        ...
        <h2 className="pt-4">5. Data Storage and Security</h2>
        <p>
        ...
        <h2 className="pt-4">6. Data Retention</h2>
        <p>
        ...
        <h2 className="pt-4">7. Data Subject Rights</h2>
        <p>
        ...
        <h2 className="pt-4">8. Changes to this Privacy Policy</h2>
        <p>
          We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.
        </p>

        <h2 className="pt-4">9. Disclaimer</h2>
        <p>
