  ...
  const handleGenerateAnalysis = () => {
    startTransition(async () => {
      ...
      const result = await getMarketResearch({
        properties_data: JSON.stringify(propertiesToAnalyse, null, 2),
        currency: currency,
        prompt: prompt,
      });
      ...
      if (result.error) {
        setError({
          code: result.error,
          hint: result.hint || 'An unexpected error occurred.',
        });
      } else {
              ...
              {isPending ? (
                <div className="flex flex-col items-center justify-center min-h-[300px]">
                  ...
                  <p className="mt-4 text-muted-foreground">
                    Analysing market data, please wait...
                  </p>
                ...
                <div className="space-y-4">
                  <div className="text-center space-y-4">
                    ...
                    <p className="mt-4 max-w-md mx-auto text-muted-foreground">
                      This tool will use AI to analyse your portfolio based on
                      market data. The generated report will assess if your
                      rental prices are competitive and provide recommendations.
                    </p>
                  </div>
                  <Collapsible>
