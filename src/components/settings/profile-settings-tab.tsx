...
import { firestore } from '@/firebase'; // Import firestore explicitly if needed
import type { ResidencyStatus, UserSettings } from '@/lib/db-types';
...
export default function ProfileSettingsTab() {
  ...
  // const { firestore } = useFirebase(); // Removed invalid hook
  const { settings, updateSettings, loading: dataLoading } = useDataContext();
  ...
  useEffect(() => {
    if (!isEditing || !tempSettings || !settings) return;
